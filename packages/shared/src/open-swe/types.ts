...
export const GraphConfigurationMetadata: {
  ...
  maxBudgetTokens: {
    x_open_swe_ui_config: {
      ...
      max: 50_000_000,
      description:
        "Maximum total tokens (input + output) allowed across all LLM calls in the entire workflow. When exceeded, the agent will terminate.",
    },
  },
  maxBudgetToolCalls: {
    x_open_swe_ui_config: {
      ...
      max: 1000,
      description:
        "Maximum number of external tool invocations permitted during the entire workflow execution.",
    },
  },
  maxBudgetActions: {
    x_open_swe_ui_config: {
...
export const GraphConfiguration = z.object({
  ...
  /**
   * Maximum total tokens across all LLM calls in the workflow.
   * @default 2_000_000
   */
  maxBudgetTokens: withLangGraph(z.number().optional(), {
    metadata: GraphConfigurationMetadata.maxBudgetTokens,
  }),
  /**
   * Maximum number of tool invocations in the workflow.
   * @default 200
   */
  maxBudgetToolCalls: withLangGraph(z.number().optional(), {
    metadata: GraphConfigurationMetadata.maxBudgetToolCalls,
  }),
  /**
   * Maximum number of agent loop iterations in the workflow.
   * @default 150
   */
